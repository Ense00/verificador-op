...
- Historial de cambios: [`CHANGELOG.md`](CHANGELOG.md) · etiqueta `vX.Y.Z` por versión
- Antes de publicar: `bash tests/revisar.sh` (sello de versión = CHANGELOG, `index.html` regenerado, sin datos reales)
